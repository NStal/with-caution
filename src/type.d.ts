declare namespace Caution {
    ...
    type WithCautionFunction<T = any, TReason extends string = string, TError extends Error = Error> = (...args: any[]) => Res<T, TReason, TError>
    type ReasonOf<TFn extends WithCautionFunction> = TFn extends (...args: any[]) => Res<any, infer R, any> ? R : never;
